...
const std::unordered_map<std::string, std::string> explanationMap = {
    ...
    {"reference", "An alias for another variable, often used to refer to an existing object."},
    {"virtual", "A keyword used to indicate that a method can be overridden in a derived class."},
    {"override", "A keyword used to indicate that a method is intended to override a base class method."},
    {"operator", "A special symbol or keyword used to perform operations on operands."},
    {"head", "The beginning element of a data structure, often used in linked lists."},
    {"tail", "The last element of a data structure, often used in linked lists."},
    {"ln", "Command for creating a symbolic link in Unix-like systems."},
    {"cp", "Command for copying files or directories in Unix-like systems."},
    {"mv", "Command for moving or renaming files or directories in Unix-like systems."},
    {"rm", "Command for removing files or directories in Unix-like systems."},
    {"touch", "Command for creating empty files or updating timestamps in Unix-like systems."},
    {"mkdir", "Command for creating directories in Unix-like systems."},
    {"rmdir", "Command for removing empty directories in Unix-like systems."},
    {"ls", "Command for listing directory contents in Unix-like systems."},
    {"pwd", "Command for printing the current working directory in Unix-like systems."},
    {"cd", "Command for changing the current working directory in Unix-like systems."},
    {"bash", "A Unix shell and command language."},
    {"sh", "The Bourne shell, a command-line interpreter for Unix-like systems."},
    {"ps aux", "Command for displaying detailed information about all running processes in Unix-like systems."},
    {"byte", "A data unit consisting of 8 bits."},
    {"void", "A data type indicating no value or no data."},
    {"transient", "A keyword used to indicate that a field should not be serialized."},
    {"destructor", "A special method called when an object is destroyed."},
    {"field", "A variable defined within a class or structure."},
    {"variable", "A storage location identified by a name used to hold data."},
    {"typeof", "An operator that returns the data type of a variable."},
    {"null", "A special value representing no value or a non-existent object."},
    {"undefined", "A state where a variable has been declared but not assigned a value."},
    {"NaN", "Stands for 'Not a Number', representing a value that is not a valid number."},
    {"Infinity", "A special value representing an infinite value."},
    {"MOV", "Assembly language instruction for moving data from one location to another."},
    {"ADD", "Assembly language instruction for adding two values."},
    {"SUB", "Assembly language instruction for subtracting one value from another."},
    {"MUL", "Assembly language instruction for multiplying two values."},
    {"DIV", "Assembly language instruction for dividing one value by another."},
    {"AND", "Assembly language instruction for performing a bitwise AND operation."},
    {"OR", "Assembly language instruction for performing a bitwise OR operation."},
    {"XOR", "Assembly language instruction for performing a bitwise XOR operation."},
    {"NOT", "Assembly language instruction for performing a bitwise NOT operation."},
    {"SHL", "Assembly language instruction for shifting bits to the left."},
    {"SHR", "Assembly language instruction for shifting bits to the right."},
    {"CMP", "Assembly language instruction for comparing two values."},
    {"JMP", "Assembly language instruction for an unconditional jump to another instruction."},
    {"JE", "Assembly language instruction for jumping if equal."},
    {"JNE", "Assembly language instruction for jumping if not equal."},
    {"JG", "Assembly language instruction for jumping if greater."},
    {"JL", "Assembly language instruction for jumping if less."},
    {"JGE", "Assembly language instruction for jumping if greater or equal."},
    {"JLE", "Assembly language instruction for jumping if less or equal."},
    {"CALL", "Assembly language instruction for calling a procedure or function."},
    {"RET", "Assembly language instruction for returning from a procedure or function."},
    {"PUSH", "Assembly language instruction for pushing a value onto the stack."},
    {"POP", "Assembly language instruction for popping a value off the stack."},
    {"LEA", "Assembly language instruction for loading the effective address of an operand."},
    {"NOP", "Assembly language instruction for no operation."},
    {"INT", "Assembly language instruction for generating a software interrupt."},
    {"HLT", "Assembly language instruction for halting the CPU."},
    {"INC", "Assembly language instruction for incrementing a value."},
    {"DEC", "Assembly language instruction for decrementing a value."},
    ...
    {"AX", "A 16-bit general-purpose register in x86 assembly."},
    {"BX", "A 16-bit general-purpose register in x86 assembly."},
    {"CX", "A 16-bit general-purpose register in x86 assembly."},
    {"DX", "A 16-bit general-purpose register in x86 assembly."},
    {"EAX", "A 32-bit general-purpose register in x86 assembly."},
    {"EBX", "A 32-bit general-purpose register in x86 assembly."},
    {"ECX", "A 32-bit general-purpose register in x86 assembly."},
    {"EDX", "A 32-bit general-purpose register in x86 assembly."},
    {"unsigned", "A type modifier indicating that a variable can only hold non-negative values."},
    {"signed", "A type modifier indicating that a variable can hold both positive and negative values."},
    {"register", "A keyword indicating that a variable should be stored in a CPU register for faster access."},
    {"scanf", "A standard C function for reading formatted input from stdin."},
    {"malloc", "A standard C function for allocating memory dynamically."},
    {"free", "A standard C function for deallocating previously allocated memory."},
    {"calloc", "A standard C function for allocating memory and initializing it to zero."},
    {"realloc", "A standard C function for resizing previously allocated memory."},
    {"define", "A preprocessor directive for defining macros or constants."},
    {"fn", "A keyword used in some languages to define a function."},
    {"Vec", "A resizable array or vector type, commonly used in languages like Rust."},
    {"HashSet", "A collection type that stores unique elements, typically implemented as a hash table."},
    {"initialize", "The process of setting a variable to a known value or state before use."},
    {"block", "A group of statements or code enclosed within curly braces, used for scoping variables and control flow."},
    {"proc", "Short for 'procedure', a function or subroutine in some programming languages."},
    {"rescue", "A keyword used in Ruby for handling exceptions."},
    {"ensure", "A keyword used in Ruby to ensure that code is executed regardless of whether an exception is raised."},
    {"retry", "A keyword used in Ruby to retry a block of code after an exception is rescued."},
    {"begin", "A keyword used in Ruby to start a block of code, often used with exception handling."},
    {"next", "A keyword used to skip the current iteration of a loop and proceed with the next iteration."},
    {"redo", "A keyword used to redo the current iteration of a loop from the beginning."},
    {"until", "A loop construct that continues executing as long as a condition is false."},
    {"elsif", "A keyword used in Ruby for additional conditional branches in an if-else construct."},
